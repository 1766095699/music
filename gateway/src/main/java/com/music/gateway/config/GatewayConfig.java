...
// * @Description sentinel整合Gateway的配置
// * @Author 86183
// * @Date2022-06-1721:44
// * @Version 1.0
// **/
...
//                    add(new ApiPathPredicateItem().setPattern("/songs/songs1/api1/**").
//                            setMatchStrategy(SentinelGatewayConstants.URL_MATCH_STRATEGY_PREFIX));
//                }});
//        ApiDefinition api2 = new ApiDefinition("user_api2")
//                .setPredicateItems(new HashSet<ApiPredicateItem>() {{
//                    // 以/server-user/user/api2/demo1 完成的url路径匹配
//                    add(new ApiPathPredicateItem().setPattern("/songs/songs1/api2/test5"));
//                }});
...
//        //歌曲微服务网关
//        rules.add(this.getGatewayFlowRule(getResource("music-songs")));
//        //用户微服务网关
//        rules.add(this.getGatewayFlowRule(getResource("music-auth")));
////        //订单微服务网关
